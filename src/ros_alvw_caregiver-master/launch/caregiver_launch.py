...
def generate_launch_description():
    ...
    #     default_value=os.path.join(get_package_share_directory('aws_robomaker_hospital_world'), 'worlds', 'hospital_empty.world'),
    #     description='Full path to world model file to load',
    # )

    declare_world_cmd = launch.actions.IncludeLaunchDescription(
        launch.launch_description_sources.PythonLaunchDescriptionSource(
            [get_package_share_directory(
                'ros_alvw_caregiver'), '/launch/hospital1.launch.py']
        ),
        launch_arguments={
            'gui': 'true'
        }.items()
    ...
    declare_robot_sdf_cmd = DeclareLaunchArgument(
        'robot_sdf',
        default_value=os.path.join(f'{home}/ros2_ws/src/ros_alvw_caregiver-master/', 'models','model_teste.sdf'),
    ...
    resume_exploration_cmd = Node(
        package='ros_alvw_caregiver',  # Substitua pelo nome do seu pacote
        executable='resume_exploration',
    ...
    ld.add_action(resume_exploration_cmd)
