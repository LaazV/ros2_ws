...
def generate_launch_description():
    ...
    bringup_dir = get_package_share_directory('ros_alvw_caregiver')
    ...
    pose = {
        ...
        'y': LaunchConfiguration('y_pose', default='3.0'),
    ...
    declare_robot_name_cmd = DeclareLaunchArgument(
        'robot_name', default_value='turtlebot3_waffle_pi', description='name of the robot'
    )
